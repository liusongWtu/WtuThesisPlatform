            ...
            <div class="single">
                 ...
                 <div class="apply-table-wrap center">
                     <table cellspacing="0" cellpadding="0" align="center" class="apply-table">
                        <tr><td class="col-name"><span style="color: red">*</span>题目：</td><td colspan="3"><input class="input-style" id="txtTitle" type="text" /></td></tr>
                        <tr><td class="col-name"><span style="color: red">*</span>开发平台</td><td><input class="input-style" id="platform" type="text" /></td><td class="col-name"><span style="color: red">*</span>限选人数</td><td><input id="number" class="input-style" type="text" /></td></tr>
