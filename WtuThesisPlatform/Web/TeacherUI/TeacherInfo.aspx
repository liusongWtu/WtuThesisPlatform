    ...
    <div class="wrap">
        <div class="person-info">
            <dl>
                ...
                <dd>
                    主讲课程：<textarea cols="50" rows="3" id="tTeachCourse" class="tTeachCourse"></textarea>
                </dd>
                <dd>
                    研究方向：<textarea cols="50" rows="3" id="tResearchFields" class="tResearchFields"></textarea>
                </dd>
