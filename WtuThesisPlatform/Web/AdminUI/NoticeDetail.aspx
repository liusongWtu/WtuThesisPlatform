<%@ Page Title="" Language="C#" MasterPageFile="~/AdminUI/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="NoticeDetail.aspx.cs" Inherits="Web.AdminUI.NoticeDetail" %>
            ...
            <div class="single">
                 ...
                 <div class="bottom">
                   <%-- <table class="tab-down">
                    ...
                    <div class="backLink"><a href="NoticeManager.aspx?nodeId=3042">返回全部公告</a></div>
                 </div>
