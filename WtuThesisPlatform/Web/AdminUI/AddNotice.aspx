<%@ Page Title="" Language="C#" MasterPageFile="~/AdminUI/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AddNotice.aspx.cs" Inherits="Web.AdminUI.AddNotice" %>
            ...
            <div class="single">
                 ...
                 <div class="noticeContent center">
                     <table class="notice-excel">
                        <tr><td class="tab-name"><h2>公告名称：</h2></td></tr>
                        ...
                        <tr><td class="tab-name"><h2>发布单位：</h2></td></tr>
                        <tr><td><input type="text" runat="server" class="txtUnits" id="txtUnits" /><asp:RequiredFieldValidator ID="rfvUnits"
                                runat="server" ErrorMessage="*" style="color:Red;" ControlToValidate="txtUnits"></asp:RequiredFieldValidator></td></tr>
                        <tr><td class="tab-name"><h2>截止日期：</h2></td></tr>
                        <tr><td><input id="deadLine"  class="deadline"  runat="server"  /><asp:RequiredFieldValidator ID="rfvDeadTime"
