...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <div id="StuAddNew">
        <table class="addTable">
            ...
            <tr><td>院系：</td><td ><select  class="DId"></select></td><td><span id="Span1" style="color: red; display: none">*</span></td><td>毕业届：</td><td><input type="text"  class="SYear" /></td><td><span id="SYearError" style="color: red; display: none">*</span></td></tr>
