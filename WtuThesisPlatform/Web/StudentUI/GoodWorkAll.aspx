<%@ Page Title="" Language="C#" MasterPageFile="~/StudentUI/StudentMasterPage.Master"
    AutoEventWireup="true" CodeBehind="GoodWorkAll.aspx.cs" Inherits="Web.StudentUI.GoodWorkAll" %>
                ...
                <table cellspacing="0" cellpadding="0" style="width: 890px;">
                    <asp:Repeater ID="rptGoodWork" runat="server">
                        <ItemTemplate>
                            ...
                            <tr>
                                <td class="work-summary fn-ellipsis fn-text-wrap" colspan="2">
                                    <%# Eval("GContent").ToString().Length < 150 ? Eval("GContent").ToString() : Eval("GContent").ToString().Substring(0, 150)+"..."%>
