    ...
    <div class="wrap">
        <div class="stu-info">
            <dl>
                ...
                <dd>
                    院系：<input type="text" id="sFaculty" runat="server" value="数学与计算机学院" readonly="readonly" /></dd>
                <dd>
                    Q Q：
                ...
                <dd>
                    邮箱：<input type="text" id="sEmail" runat="server" value="594659037@qq.com" readonly="readonly" /></dd>
            </dl>
            <!--<div id="tPhoto">
								待定
							</div>-->
