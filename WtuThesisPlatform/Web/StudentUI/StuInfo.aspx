    ...
    <div class="wrap">
        <div class="stu-info">
            <dl>
                ...
                <dd>
                    届数：<input type="text" id="sYear" runat="server" value="" readonly="readonly" /></dd>
                <dd>
                    院系：<select id="sFaculty" runat="server" disabled="disabled">
                    </select></dd>
                <dd>
                    专业：<select id="sProfession" runat="server" disabled="disabled">
                    </select></dd>
                <dd>
                    班级：<select id="sClass" runat="server" disabled="disabled">
                    </select></dd>
                <dd>
