...
namespace WtuThesisPlatform.BLL
{
    /// <summary>
    /// Author: LiuSong
    /// Description: BLLTier -- the BLL class of Admin.
    ...
    public class AdminBLL
    {
        ...
        public IList<Admin> GetListByProc(string procName,System.Data.SqlClient.SqlParameter[] paras)
        {
        ...
        /// </summary>
        public Admin GetModel(string userName)
        {
