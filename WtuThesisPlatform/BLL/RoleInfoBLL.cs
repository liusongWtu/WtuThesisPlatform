...
namespace WtuThesisPlatform.BLL
{
    ...
    /// Datetime:2013/4/16 15:29:32
    /// </summary>
    public class RoleInfoBLL
    {
        private readonly RoleInfoDAL dal = new RoleInfoDAL();
        ...
        public IList<RoleInfo> GetListByProc(string procName,System.Data.SqlClient.SqlParameter[] paras)
        {
