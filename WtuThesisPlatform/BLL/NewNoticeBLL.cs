...
namespace WtuThesisPlatform.BLL
{
    /// <summary>
    /// Author: LiuSong
    /// Description: BLLTier -- the BLL class of NewNotice.
    /// Datetime:2013/4/22 16:14:22
    /// </summary>
    public class NewNoticeBLL
    {
        private readonly NewNoticeDAL dal = new NewNoticeDAL();
        ...
        public IList<NewNotice> GetListByProc(string procName,System.Data.SqlClient.SqlParameter[] paras)
        {
