...
namespace WtuThesisPlatform.BLL
{
    /// <summary>
    /// Author: LiuSong
    /// Description: BLLTier -- the BLL class of OnlineUser.
    /// Datetime:2013/4/16 15:29:18
    /// </summary>
    public class OnlineUserBLL
    {
        private readonly OnlineUserDAL dal = new OnlineUserDAL();
        ...
        public IList<OnlineUser> GetListByProc(string procName,System.Data.SqlClient.SqlParameter[] paras)
        {
