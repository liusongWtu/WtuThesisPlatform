...
namespace WtuThesisPlatform.BLL
{
    ...
    {
        private readonly TBSys_IdManagerDAL dal = new TBSys_IdManagerDAL();
        ...
        public IList<TBSys_IdManager> GetListByProc(string procName,System.Data.SqlClient.SqlParameter[] paras)
        {
